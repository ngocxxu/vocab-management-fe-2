...
const multiSelectVariants = cva('m-1 transition-all duration-300 ease-in-out', {
  variants: {
    variant: {
      ...
      destructive: 'border-transparent bg-destructive text-destructive hover:bg-destructive/80',
      inverted: 'bg-background text-foreground hover:bg-background/80',
    },
    badgeAnimation: {
...
} & Omit<React.ButtonHTMLAttributes<HTMLButtonElement>, 'animationConfig'> & VariantProps<typeof multiSelectVariants> & { asChild?: boolean };
